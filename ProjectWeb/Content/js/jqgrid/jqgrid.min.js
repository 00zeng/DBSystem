...
(function (factory) {
        ...
        return this.each(function () {
            ...
            endReq = function () {
                ...
                if (ts.p.unwritten) {
                    ...
                    if ($("#" + ts.p.id).find('tbody tr').length == 1) {
                        $("#" + ts.p.id).parents('.ui-jqgrid-bdiv').append('<div class="unwritten" style="color:#8DABC4;padding:7px;">没有找到您要的相关数据!</div>')
                    }
                }
            },
            ...
            setPager = function (pgid, tp) {
                ...
                if (ts.p.pgbuttons === true) {
                    ...
                    $("#first" + $.jgrid.jqID(tp) + ", #prev" + $.jgrid.jqID(tp) + ", #next" + $.jgrid.jqID(tp) + ", #last" + $.jgrid.jqID(tp)).on("mousedown", function () {
                        if ($(this).hasClass(disabled)) {
                            return false;
                        }
    ...
    $.extend($.jgrid, {
        ...
        createModal: function (aIDs, content, p, insertSelector, posSelector, appendsel, css) {
            ...
            $("a.ui-jqdialog-titlebar-close", mh).on("mousedown", function () {
        ...
        info_dialog: function (caption, content, c_b, modalopt) {
            ...
            $("#closedialog", "#info_id").on("mousedown", function () {
    ...
    $.jgrid.extend({
        filterToolbar: function (p) {
            ...
            return this.each(function () {
                ...
                $(".clearsearchclass", tr).on("mousedown", function () {
    ...
    $.jgrid.extend({
        editGridRow: function (rowid, p) {
            ...
            return this.each(function () {
                ...
                if (rp_ge[$t.p.id].checkOnSubmit || rp_ge[$t.p.id].checkOnUpdate) {
                    ...
                    $("#sNew", "#" + $.jgrid.jqID(IDs.themodal)).on("mousedown", function () {
                        postIt();
                        $(frmgr).data("disabled", false);
                        $(".confirm", "#" + $.jgrid.jqID(IDs.themodal)).hide();
                        return false;
                    });
                    $("#nNew", "#" + $.jgrid.jqID(IDs.themodal)).on("mousedown", function () {
                        $(".confirm", "#" + $.jgrid.jqID(IDs.themodal)).hide();
                        $(frmgr).data("disabled", false);
                        setTimeout(function () { $(":input:visible", frmgr)[0].focus(); }, 0);
                        return false;
                    });
                    $("#cNew", "#" + $.jgrid.jqID(IDs.themodal)).on("mousedown", function () {
                        $(".confirm", "#" + $.jgrid.jqID(IDs.themodal)).hide();
                        $(frmgr).data("disabled", false);
                        $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal), { gb: "#gbox_" + $.jgrid.jqID(gID), jqm: p.jqModal, onClose: rp_ge[$t.p.id].onClose, removemodal: rp_ge[$t.p.id].removemodal, formprop: !rp_ge[$t.p.id].recreateForm, form: rp_ge[$t.p.id].form });
                        return false;
                ...
                if (!closeovrl) {
                    $("." + $.jgrid.jqID(p.overlayClass)).on("mousedown", function () {
                        if (!checkUpdates()) { return false; }
                        $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal), { gb: "#gbox_" + $.jgrid.jqID(gID), jqm: p.jqModal, onClose: rp_ge[$t.p.id].onClose, removemodal: rp_ge[$t.p.id].removemodal, formprop: !rp_ge[$t.p.id].recreateForm, form: rp_ge[$t.p.id].form });
                        return false;
                    });
                ...
                $("#sData", frmtb2).on("mousedown", function () {
                    postdata = {};
                    $(".FormError", frmgr).hide();
                ...
                $("#cData", frmtb2).on("mousedown", function () {
                    if (!checkUpdates()) { return false; }
                    $.jgrid.hideModal("#" + $.jgrid.jqID(IDs.themodal), { gb: "#gbox_" + $.jgrid.jqID(gID), jqm: p.jqModal, onClose: rp_ge[$t.p.id].onClose, removemodal: rp_ge[$t.p.id].removemodal, formprop: !rp_ge[$t.p.id].recreateForm, form: rp_ge[$t.p.id].form });
                    return false;
                });
                $("#nData", frmtb2).on("mousedown", function () {
                    if (!checkUpdates()) { return false; }
                    $(".FormError", frmgr).hide();
                    var npos = getCurrPos();
                ...
                $("#pData", frmtb2).on("mousedown", function () {
                    if (!checkUpdates()) { return false; }
                    $(".FormError", frmgr).hide();
                    var ppos = getCurrPos();
        ...
        viewGridRow: function (rowid, p) {
            ...
            return this.each(function () {
                ...
                focusaref();
                $("#cData", "#" + frmtb + "_2").on("mousedown", function () {
                ...
                $("#nData", "#" + frmtb + "_2").on("mousedown", function () {
                ...
                $("#pData", "#" + frmtb + "_2").on("mousedown", function () {
                    $("#FormError", "#" + frmtb).hide();
                    var ppos = getCurrPos();
                    if (ppos[0] !== -1 && ppos[1][ppos[0] - 1]) {
                        if ($.isFunction(p.onclickPgButtons)) {
        ...
        delGridRow: function (rowids, p) {
            ...
            return this.each(function () {
                ...
                if ($("#" + $.jgrid.jqID(IDs.themodal))[0] !== undefined) {
                    ...
                    $("#dData", "#" + dtbl + "_2").on("mousedown", function () {
                        var ret = [true, ""], pk,
                    ...
                    $("#eData", "#" + dtbl + "_2").on("mousedown", function () {
            ...
            return this.each(function () {
                ...
                _buildMenu = function () {
                    ...
                    if (p.add) {
                        ...
                        itm = $('<li class="ui-menu-item" role="presentation"><a class="' + commonstyle.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + eid + '">' + (p.addtext || p.addtitle) + '</a></li>').on("mousedown", function () {
                            if (!$(this).hasClass(commonstyle.disabled)) {
                    ...
                    if (p.edit) {
                        ...
                        itm = $('<li class="ui-menu-item" role="presentation"><a class="' + commonstyle.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + eid + '">' + (p.edittext || p.edittitle) + '</a></li>').on("mousedown", function () {
                            if (!$(this).hasClass(commonstyle.disabled)) {
                                var sr = $t.p.selrow;
                                if (sr) {
                    ...
                    if (p.view) {
                        ...
                        itm = $('<li class="ui-menu-item" role="presentation"><a class="' + commonstyle.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + eid + '">' + (p.viewtext || p.viewtitle) + '</a></li>').on("mousedown", function () {
                            if (!$(this).hasClass(commonstyle.disabled)) {
                                var sr = $t.p.selrow;
                                if (sr) {
                                    if ($.isFunction(p.editfunc)) {
                    ...
                    if (p.del) {
                        ...
                        itm = $('<li class="ui-menu-item" role="presentation"><a class="' + commonstyle.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + eid + '">' + (p.deltext || p.deltitle) + '</a></li>').on("mousedown", function () {
                            if (!$(this).hasClass(commonstyle.disabled)) {
                                var dr;
                                if ($t.p.multiselect) {
                                    dr = $t.p.selarrrow;
                    ...
                    if (p.search) {
                        ...
                        itm = $('<li class="ui-menu-item" role="presentation"><a class="' + commonstyle.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + eid + '">' + (p.searchtext || p.searchtitle) + '</a></li>').on("mousedown", function () {
                            if (!$(this).hasClass(commonstyle.disabled)) {
                    ...
                    if (p.refresh) {
                        eid = pSearch.id || "search_" + elemids;
                        itm = $('<li class="ui-menu-item" role="presentation"><a class="' + commonstyle.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + eid + '">' + (p.refreshtext || p.refreshtitle) + '</a></li>').on("mousedown", function () {
                            if (!$(this).hasClass(commonstyle.disabled)) {
    ...
    hs = function (w, t, c) {
        return w.each(function () {
            var s = this._jqm; $(t).each(function () {
                if (!this[c]) { this[c] = []; $(this).on("mousedown", function () { for (var i in { jqmShow: 1, jqmHide: 1 }) { for (var s in this[i]) { if (H[this[i][s]]) { H[this[i][s]].w[i](this); } } } return F; }); }
                this[c].push(s);
            });
        });
    };
