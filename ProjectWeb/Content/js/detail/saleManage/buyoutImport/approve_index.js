...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/SaleManage/BuyoutImport/Approve?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
        }
    },
    {
...
//                return "<a href='/SaleManage/BuyoutImport/Approve?id=" + row.id + " 'title='点击前往审批页面'><span class='label label-warning'>未审批</span></a>";
            else
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/BuyoutImport/GetGridJson2?date=" + new Date(),        //请求后台的URL（*）
