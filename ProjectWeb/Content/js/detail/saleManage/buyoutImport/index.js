...
var tableHeader = [
    ...
    { field: "distributor_name", title: "实销售点", align: "center", sortable: true, width: 200 },
    { field: "distributor_code", title: "编号", align: "center", sortable: true, width: 100 },
    { field: "area_l2_name", title: "区域", align: "center", sortable: true, width: 120 },
    { field: "phone_sn", title: "串码", align: "center", sortable: true, width: 150 },
    { field: "sale_status", title: "状态", align: "center", sortable: true, width: 100 },
    { field: "model", title: "型号", align: "center", sortable: true, width: 120 },
    { field: "color", title: "颜色", align: "center", sortable: true, width: 100 },
    { field: "accur_time", title: "最后操作日期", align: "center", sortable: true, width: 150, formatter: (function (value) { var date = new Date(value); return date.pattern("yyyy-MM-dd"); }) },
    {
        field: "price_wholesale", title: "批发价", align: "center", sortable: true, width: 100,
        formatter: (function (value) { return ToThousandsStr(value); })
    },
    {
        field: "price_buyout", title: "买断价", align: "center", sortable: true, width: 100,
        formatter: (function (value) { return ToThousandsStr(value); })
    },
    {
    ...
    { field: "guide_name", title: "促销员", align: "center", sortable: true, width: 100 },
    {
        field: "buyout_refund", title: "买断补差", align: "center", sortable: true, width: 100,
        formatter: (function (value) { return ToThousandsStr(value); })
    },
    {
    ...
    {
        field: "sales_commission", title: "业务提成", align: "center", sortable: true, width: 100,
        formatter: (function (value) { return ToThousandsStr(value); })
    },
    { field: "import_file", title: "导入文件名", align: "center", sortable: true, width: 150 },
    { field: "creator_name", title: "导入人", align: "center", sortable: true, width: 100 },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/BuyoutImport/GetGridJson?date=" + new Date(),        //请求后台的URL（*）
            ...
            queryParams: function (params) {
                var param = {
                    ...
                    startTime1: $('#start_date').val(),
                    startTime2: $('#end_date').val(),
