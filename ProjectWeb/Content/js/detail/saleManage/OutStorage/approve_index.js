...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/SaleManage/OutStorage/Approve?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
        }
    },
    {
    ...
    },
    {
        ...
        formatter: function (value, row, index) {
            if (value < 0)
                ...
                //  return "<a href='/SaleManage/OutStorage/Approve?id=" + row.id + " 'title='点击前往审批'><span class='label label-warning'>未审批</span></a>";
            else
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/OutStorage/GetGridJson3?date=" + new Date(),        //请求后台的URL（*）
