...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/SaleManage/BuyoutInfo/Approve?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
        }
    },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/BuyoutInfo/GetListApprove?date=" + new Date(),        //请求后台的URL（*）
            ...
            onClickRow: function (row) {
                location.href = "/SaleManage/BuyoutInfo/Approve?id=" +row.id;
