    ...
    },
     {
         ...
         formatter: function (value, row, index) {
             if (value < 0)
                 ...
                 return "<a href='/SaleManage/BuyoutInfo/Confirm?id=" + row.id + " 'title='点击前往审批'><span class='label label-warning'>未审批</span></a>";
             else
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/BuyoutInfo/GetListConfirm?date=" + new Date(),        //请求后台的URL（*）
            ...
            onClickRow: function (row) {
                location.href = "/SaleManage/BuyoutInfo/Confirm?id=" + row.id;
