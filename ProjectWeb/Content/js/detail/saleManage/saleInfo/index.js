...
var tableHeader = [
   {
    ...
    { field: "reporter_name", title: "上报人", align: "center", sortable: true, width: 120 },
    { field: "sale_status", title: "状态", align: "center", sortable: true, width: 120 },
    { field: "area_l2_name", title: "区域", align: "center", sortable: true, width: 150 },
    { field: "company_name", title: "机构", align: "center", sortable: true, width: 150 },
    { field: "accur_time", title: "日期", align: "center", sortable: true, width: 150, formatter: (function (value) { var date = new Date(value); return date.pattern("yyyy-MM-dd hh:mm"); }) },
    { field: "sales_name", title: "业务员", align: "center", sortable: true, width: 150 },
...
function Del(obj) {
    ...
    top.layer.confirm("您确认要删除经销商：“" + name + "”，串码：“" + phone_sn + "”的实销信息吗？", function (index) {
        ...
        data["status"] = 2;
        $.submitForm({
            url: "/SaleManage/SaleInfo/UpdateCheckStatus?date=" + new Date(),
            param: data,
...
function Keeping(obj) {
    ...
    top.layer.confirm("您确认要保留经销商：“" + name + "”，串码：“" + phone_sn + "”的实销信息，并删除其他重复串码的信息吗？", function (index) {
        ...
        data["id"] = id;
        $.submitForm({
            url: "/SaleManage/SaleInfo/Keeping?date=" + new Date(),
            param: data,
            success: function (data) {
                if (data.state == "success") {
                    $.currentWindow().ReSearch();
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/SaleInfo/GetGridJson?date=" + new Date(),        //请求后台的URL（*）
