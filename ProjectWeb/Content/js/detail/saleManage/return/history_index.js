...
var tableHeader = [
     {
         ...
         formatter: function (value, row) {
             return "<a class='btn btn-primary btn-xs' href='/SaleManage/Return/Show?id=" + row.id + " ' title='查看详情'><i class='fa fa-search'></i></a>";
         }
     },
    {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/return/GetGridJson2?date=" + new Date(),        //请求后台的URL（*）
