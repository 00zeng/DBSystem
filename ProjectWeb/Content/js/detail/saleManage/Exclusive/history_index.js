...
var tableHeader = [
     {
         ...
         formatter: function (value, row) {
             return "<a class='btn btn-primary btn-xs' href='/SaleManage/Exclusive/Show?id=" + row.id + " ' title='查看详情'><i class='fa fa-search'></i></a>";
         }
     },
    {
   ...
   //             return "<a href='/SaleManage/Exclusive/Approve?id=" + row.id + " 'title='点击前往审批页面'><span class='label label-warning'>未审批</span></a>";
            else
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/Exclusive/GetListHistory?date=" + new Date(),        //请求后台的URL（*）
