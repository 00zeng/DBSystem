...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            console.log(row);
            return "<a class='btn btn-primary btn-xs' href='/SaleManage/Exclusive/Approve?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
        }
    },
    {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SaleManage/Exclusive/GetListApprove?date=" + new Date(),        //请求后台的URL（*）
