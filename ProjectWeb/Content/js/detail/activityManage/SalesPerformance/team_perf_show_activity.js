...
var start_date;
var end_date;
//var total_reward_sum;
//var total_sale_amount;
...
$(function () {
    $.ajax({
        ...
        success: function (data) {
            ...
            //total_reward_sum = data.perfInfo.total_reward;
            //total_sale_amount = data.perfInfo.total_sale_amount;
            //total_sale_count = data.perfInfo.total_sale_count;
...
var tableDistributorHeader = [
    ...
    {
        field: "total_count", title: "导购人数", align: "center",
        formatter: (function (value) { return ToThousandsStr(value); }),
        //footerFormatter: (function (value) { return ToThousandsStr(String(total_sale_count)); })
    },
    {
        field: "total_amount", title: "经销商数量", align: "center",
        formatter: (function (value) { return ToThousandsStr(value); }),
        //footerFormatter: (function (value) { return ToThousandsStr(String(total_sale_amount)); })
    },
    {
    ...
    },
    {
        ...
        formatter: (function (value) { return ToThousandsStr(value); }),
        //footerFormatter: (function (value) { return ToThousandsStr(String(total_reward_sum)); })
    },
]
