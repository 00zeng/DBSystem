...
$(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            checkTargetVal = data.mainInfo.target_mode;//返利模式
            ...
            if (checkTargetVal == 1) {
                ...
                $("#rebateMode1").show();
                $("#rebateMode4").hide();
                $tableEmp.bootstrapTable('showColumn', 'total_ratio');
            ...
            function RebateMode1() {
                ...
                $.each(data.rewardList, function (index, item) {
                    ...
                    tr += str1 + ToThousandsStr(item.target_min) + str2 + ToThousandsStr(item.target_max) + "' disabled><td><div class='input-group'> <div class='input-group-btn'><button type='button' class='btn btn-" + btnClass + "' name='rewards'>" + ToThousandsStr(rewards) + "</button></div><span  class='input-group-addon no-border'>"
...
var tableDistributorHeader = [
    ...
    {
        field: "total_amount", title: "正常机销售额（元）", align: "center",
        formatter: (function (value) { return ToThousandsStr(value); }),
...
var tableProductHeader = [
    ...
    {
        field: "total_count", title: "总销量", align: "center",
        formatter: (function (value) { return ToThousandsStr(value); })
    },
    {
        field: "total_normal_count", title: "正常机销量（台）", align: "center",
    ...
    {
        field: "total_normal_amount", title: "正常机销售额（元）", align: "center",
        formatter: (function (value) { return ToThousandsStr(value); })
    },
]
