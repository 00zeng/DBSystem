...
$(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var checkRebateVal = data.mainInfo.rebate_mode; //金额计算方式
            ...
            function RebateMode1() {
                ...
                $.each(data.rewardList, function (index, item) {
                    ...
                    tr += str1 + item.target_min + str2 + item.target_max + "' disabled><td><div class='input-group'> <div class='input-group-btn'><button type='button' class='btn btn-" + btnClass + "' name='rewards'>" + rewards + "</button></div><span  class='input-group-addon no-border'>"
...
var tableEmpHeader = [
    ...
    { field: "total_amount", title: "累计总金额（元）", align: "center", },
    { field: "total_ratio", title: "累计完成率（%）", align: "center", },
    { field: "total_rebate", title: "返利金额", align: "center", },
]
