...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            if (row.category == 1) {
                return "<a class='btn btn-primary btn-xs' href='/ActivityManage/SalesPerformance/MonthlyPerfApprove?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
            } else if (row.category == 2) {
                return "<a class='btn btn-primary btn-xs' href='/ActivityManage/SalesPerformance/SalePerfApprove?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
            } else if (row.category == 3) {
                return "<a class='btn btn-primary btn-xs' href='/ActivityManage/SalesPerformance/TeamPerfApprove?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
            }
        }
    },
    {
        field: "name", title: "考核名称", align: "center", width: 100, sortable: true,       
    },
     {
         field: "category", title: "考核类型", align: "center", width: 100,
    ...
    { field: "company_name", title: "分公司", align: "center", width: 100, sortable: true },
    {
        field: "activity_status", title: "活动状态", align: "center", width: 100,
     ...
     {
         field: "approve_status", title: "审批状态", align: "center", width: 100,
    ...
    {
        field: "end_date", title: "考核周期", align: "center", width: 120, sortable: true,
        formatter: function (value, row, index) {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/ActivityManage/SalesPerformance/GetListApprove?date=" + new Date(),         //请求后台的URL（*）
