...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/DistributorManage/ShippingBill/Approve?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
        }
    },
    {
...
//                return "<a href='/DistributorManage/ShippingBill/Approve?id=" + row.id + " 'title='点击前往审批'><span class='label label-warning'>未审批</span></a>";
            else
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/DistributorManage/ShippingBill/GetApproveList?date=" + new Date(),        //请求后台的URL（*）
