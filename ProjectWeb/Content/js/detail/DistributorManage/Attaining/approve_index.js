...
var tableHeader = [
    {
        ...
        formatter: (function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/DistributorManage/Attaining/Approve?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
        })
    },
    {
    ...
    { field: "distributor_count", title: "经销商数量", align: "center", sortable: true },
    {
    ...
    { field: "activity_target", title: "目标销量（台）", align: "center", sortable: true, },
    {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/DistributorManage/Attaining/GetGridJson2?date=" + new Date(),        //请求后台的URL（*）
