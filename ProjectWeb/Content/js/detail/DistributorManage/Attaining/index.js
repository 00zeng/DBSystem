...
var tableHeader = [
    ...
    {
        field: "name", title: "活动名称", align: "center", sortable: true, width: 200,
    },
     {
         field: "category", title: "返利类别", align: "center", sortable: true, width: 200,
         formatter: function (value) {
             switch (value) {
                 case 2: return "主推返利";
                 case 3: return "订货返利";
                 case 4: return "无促保卡返利";
                 default: return "达量返利";
             }
         }
     },
    ...
    {
        field: "target_sale", title: "销量阶梯", align: "center", sortable: true, width: 100,
        formatter: function (value) {
            if (value == 1) {
                return "按完成率";
            } else if (value == 2) {
