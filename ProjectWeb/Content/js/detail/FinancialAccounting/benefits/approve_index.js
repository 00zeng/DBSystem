...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/Benefits/Approve?id=" + row.id + "'title='审批'><i class='fa fa-check-square-o'></i></a>";
        }
    },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/Benefits/GetListMyApprove?date=" + new Date(),        //请求后台的URL（*）
            ...
            onClickRow: function (row) {
                location.href = "/FinancialAccounting/Benefits/Approve?id=" + row.id;
            }
        });
    };
    return oTableInit;
