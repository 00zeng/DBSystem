...
$(function () {
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.benefitsInfo.exclude_entry_date == null) {
            } else {
            ...
            $.each(data.benefitslistInfo, function (index, item) {
                ...
                tr = '<tr><td>' + item.name + '</td>' + '<td>' + paid_type + '</td>' + '<td>' + ToThousandsStr(item.amount) + '</td>' + '<td>' + paid_type_val + '</td>' + '<td>' + item.note + '</td></tr>';
