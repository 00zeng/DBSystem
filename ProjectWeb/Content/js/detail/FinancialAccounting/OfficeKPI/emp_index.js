...
var tableHeader = [
    {
        ...
        formatter: (function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/OfficeKPI/Add?id=" + row.id + "&company_name=" + encodeURI(encodeURI(row.company_name)) + "&position_name=" + encodeURI(encodeURI(row.position_name)) + "&name=" + encodeURI(encodeURI(row.name)) + "&grade=" + encodeURI(encodeURI(row.grade)) + "'title='KPI评分设置'><i class='fa fa-edit'></i></a>";
        })
    },
    {
    ...
    { field: "emp_category", title: "雇员等级", align: "center", sortable: true, width: 100 },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/OfficeKPI/GetList?date=" + new Date(),        //请求后台的URL（*）
