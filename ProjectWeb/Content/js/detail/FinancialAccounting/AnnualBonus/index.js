...
var tableHeader = [
 {
     ...
     formatter: function (value, row) {
         return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/AnnualBonus/Show?id=" + row.id + "&position_name=" + encodeURI(encodeURI(row.position_name))
                  + "&emp_name=" + encodeURI(encodeURI(row.emp_name)) + "&grade=" + encodeURI(encodeURI(row.grade)) + "'title='查看详情'><i class='fa fa-search'></i></a>";
     }       
 },
    {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/AnnualBonus/GetGridJson?date=" + new Date(),        //请求后台的URL（*）
