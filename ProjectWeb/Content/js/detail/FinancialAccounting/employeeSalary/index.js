...
var tableHeader = [
    {
        ...
        formatter: (function (value, row) {
            ...
            if (position_type == 31) {
                return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/EmployeeSalary/GuideShow?id=" + row.id + " ' title='查看薪资详情'><i class='fa fa-search'></i></a>";
            } else if (position_type == 21 || position_type == 22) {
                return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/EmployeeSalary/SalesShow?id=" + row.id + "'title='查看薪资详情'><i class='fa fa-search'></i></a>";
            }
            else if (position_type == 11 || position_type == 12) {
                return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/EmployeeSalary/TrainerShow?id=" + row.id + "'title='查看薪资详情'><i class='fa fa-search'></i></a>";
            }
            else {
                return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/EmployeeSalary/OfficeShow?id=" + row.id + "'title='查看薪资详情'><i class='fa fa-search'></i></a>";
            }
    ...
    { field: "position_name", title: "职位", align: "center", sortable: true, width: 110 },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/EmployeeSalary/GetGridJson?date=" + new Date(),        //请求后台的URL（*）
