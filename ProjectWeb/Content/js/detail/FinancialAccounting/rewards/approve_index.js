...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/Rewards/Approve?id=" + row.id
                   ...
                   + "&month=" + row.month + "'title='审批'><i class='fa fa-check-square-o'></i></a>";
        }
    },
    {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/Rewards/GetGridJson2?date=" + new Date(),        //请求后台的URL（*）
            ...
            //    location.href = "/FinancialAccounting/Rewards/Approve?id=" + row.id
            //        + "&name=" + encodeURI(encodeURI(row.emp_name))
            //        + "&grade=" + encodeURI(encodeURI(row.grade))
            //        + "&position_name=" + encodeURI(encodeURI(row.position_name))
            //        + "&company_name=" + encodeURI(encodeURI(row.company_name))
            //        + "&month=" + row.month;
