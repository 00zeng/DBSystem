...
var tableHeader = [
    {
        ...
        formatter: function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/Rewards/Show?id=" + row.id
                   ...
                   + "&month=" + row.month + "'title='查看详情'><i class='fa fa-search'></i></a>";
    ...
    {
        field: "month", title: "奖罚月份", align: "center", sortable: true, width: 100,
        formatter: (function (value, row) {
            if (value != "" || value != null) {
    ...
    { field: "area_l1_name", title: "经理片区", align: "center", sortable: true, width: 100 },
    { field: "area_l2_name", title: "业务片区", align: "center", sortable: true, width: 100 },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/Rewards/GetGridJson?date=" + new Date(),        //请求后台的URL（*）
            ...
            //    location.href = "/FinancialAccounting/Rewards/Show?id=" + row.id
            //        + "&name=" + encodeURI(encodeURI(row.name))
            //        + "&grade=" + encodeURI(encodeURI(row.grade))
            //        + "&position_name=" + encodeURI(encodeURI(row.position_name))
            //        + "&company_name=" + encodeURI(encodeURI(row.company_name))
