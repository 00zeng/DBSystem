...
var tableHeader = [
    {
        ...
        formatter: (function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/TrainerKPI/Show?id=" + row.id + "&company_linkname=" + encodeURI(encodeURI(row.company_linkname)) + " ' title='查看详情'><i class='fa fa-search'></i></a>";
        })
    },
    {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/TrainerKPI/GetListHistory?date=" + new Date(),        //请求后台的URL（*）
