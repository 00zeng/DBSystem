...
var tableHeader = [
     {
         ...
         formatter: function (value, row) {
             return "<a class='btn btn-primary btn-xs' href='/FinancialAccounting/StaySubsidy/Approve?id=" + row.id + "'title='审批'><i class='fa fa-check-square-o'></i></a>";
         }
     },
    { field: "count", title: "发放人数", align: "center", sortable: true },
    { field: "emp_amount", title: "每人补助金额", align: "center", sortable: true },
    {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/FinancialAccounting/StaySubsidy/GetGridJson2?date=" + new Date(),        //请求后台的URL（*）
