...
var tableHeader = [
    {
        ...
        formatter: (function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/ProductManage/CommissionInfo/Approve?id=" + row.id + " ' title='审批'><i class='fa fa-check-square-o'></i></a>";
        })
    },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/ProductManage/CommissionInfo/GetListApprove?date=" + new Date(),        //请求后台的URL（*）
