...
var tableHeader = [
    ...
    { field: "model", title: "型号", align: "center", sortable: true, width: 250 },
    { field: "color", title: "颜色", align: "center", sortable: true, width: 150 },
    
    {
        field: "guide_commission", title: "导购提成", align: "center", sortable: true, width: 150,
        formatter: (function (value) { return ToThousandsStr(value); })
    },
    {
        field: "exclusive_commission", title: "包销提成", align: "center", sortable: true, width: 150,
        formatter: (function (value) { return ToThousandsStr(value); })
    },
    {
        field: "salary_include", title: "核算底薪", align: "center", sortable: true, width: 150,
    ...
    {
        field: "effect_status", title: "状态", align: "center", sortable: true, width: 90,
    ...
    { field: "note", title: "备注", align: "center", sortable: true, width: 170 },
    ...
    { field: "create_time", title: "导入时间", align: "center", sortable: true, width: 200 },
]
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/ProductManage/CommissionInfo/GetListCommissionHistory?date=" + new Date(),        //请求后台的URL（*）
