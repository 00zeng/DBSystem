...
var tableHeader = [
    {
        ...
        formatter: (function (value, row) {
            return "<a class='btn btn-primary btn-xs' href='/SalaryCalculate/PayrollSales/Add?id=" + row.id + "&name=" + encodeURI(encodeURI(row.name)) + "&grade=" + encodeURI(encodeURI(row.grade)) + "&position_name=" + encodeURI(encodeURI(row.position_name)) + "&entry_date=" + row.entry_date + " ' title='结算'>&nbsp;<i class='fa fa-rmb'></i>&nbsp;</a>";
        })
    },
     {
    ...
    { field: "work_number", title: "工号", align: "center", },
    { field: "position_name", title: "岗位", align: "center", },
    ...
    //{ field: "grade", title: "职等", align: "center", sortable: true, width: 80 },
    //{ field: "onduty_day", title: "上班天数", align: "center", sortable: true, width: 100 },
    ...
    //{ field: "house_subsidy", title: "住房补贴", align: "center", sortable: true, width: 100 },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SalaryCalculate/PayrollSales/GetListCalculate?date=" + new Date(),        //请求后台的URL（*）
