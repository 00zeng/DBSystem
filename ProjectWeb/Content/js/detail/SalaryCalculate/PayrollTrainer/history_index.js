...
var tableHeader = [
     {
         ...
         formatter: (function (value, row) {
             return "<a class='btn btn-primary btn-xs' href='/SalaryCalculate/PayrollTrainer/Show?id=" + row.id + " ' title='查看'><i class='fa fa-search'></i></a>";
         })
     },
   { field: "name", title: "姓名", align: "center", sortable: true, width: 100, },
    ...
    {
         field: "actual_salary", title: "实发金额", align: "center", sortable: true, width: 100,
    ...
    //{ field: "kpi_snowball", title: "KPI-V雪球", align: "center", sortable: true },
    //{ field: "kpi_guide", title: "KPI-导服", align: "center", sortable: true },
    //{ field: "kpi_train", title: "KPI-培推", align: "center", sortable: true },
    //{ field: "kpi_image", title: "KPI-终端形象", align: "center", sortable: true },
    //{ field: "kpi_other", title: "KPI-其他", align: "center", sortable: true },
    {
    ...
    { field: "note", title: "备注", align: "center", sortable: true, width: 200, },
]
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SalaryCalculate/PayrollTrainer/GetListHistory?date=" + new Date(),        //请求后台的URL（*）
...
//重新查询   参数同查询参数
function Export() {
    window.location.href = "/SalaryCalculate/PayrollTrainer/Export?company_id=" + $('#company_id').val()
