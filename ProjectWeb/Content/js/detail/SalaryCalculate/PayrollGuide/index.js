...
var tableHeader = [
     {
         ...
         formatter: (function (value, row) {
             return "<a class='btn btn-primary btn-xs' href='/SalaryCalculate/PayrollGuide/Add?id=" + row.id + " ' title='结算'>&nbsp;<i class='fa fa-rmb'></i>&nbsp;</a>";
         })
     },
      {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            height: h,
            url: "/SalaryCalculate/PayrollGuide/GetListCalculate?date=" + new Date(),        //请求后台的URL（*）
