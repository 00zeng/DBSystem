...
{
    public class BuyoutImportController : ControllerBase
    {
        private BuyoutImportApp app = new BuyoutImportApp();
        #region 页面显示
        [HttpGet]
        [HandlerAuthorize]
        public ActionResult BuyoutImportAdd()
        {
            return View();
        }
        [HttpGet]
        [HandlerAuthorize]
        public ActionResult BuyoutImportApproval()
        {
            return View();
        }
        ...
        [HttpGet]
        [HandlerAuthorize]
        public ActionResult BuyoutImportShow()
        {
            return View();
        }
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson(Pagination pagination, daoben_sale_buyout_import_temp queryInfo, QueryTime queryTime)
        {  
            var data = new
            {
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson1(Pagination pagination, QueryTime queryTime, string queryName = null)
        {   
            var data = new
            {
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson2(Pagination pagination, string queryName = null)
        {
            var data = new
            {
        ...
        public ActionResult Import(string importListStr, daoben_sale_buyout_import_approve importInfo)
        {
            try
            {
                List<daoben_sale_buyout_import_temp> importList = importListStr.ToList<daoben_sale_buyout_import_temp>();
                int delCount = 0;
        ...
        [HandlerAjaxOnly]
        [ValidateAntiForgeryToken]
        public ActionResult Approve(daoben_sale_buyout_import_approve approveInfo)
        {
