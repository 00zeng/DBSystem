...
namespace ProjectWeb.Areas.SaleManage.Controllers
{
    ...
    {
        private OutStorageApp app = new OutStorageApp();
        [HttpGet]
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson(Pagination pagination, daoben_sale_outstorage queryInfo,
                    QueryTime queryTime)
        {               
            var data = new
            {
        ...
        public ActionResult Import(string importListStr, daoben_sale_outstorage_approve importInfo)
        {
            List<daoben_sale_outstorage> importList = importListStr.ToList<daoben_sale_outstorage>();
            int delCount = 0;
        ...
        [HandlerAjaxOnly]
        [ValidateAntiForgeryToken]
        public ActionResult Approve(daoben_sale_outstorage_approve approveInfo)
        {
