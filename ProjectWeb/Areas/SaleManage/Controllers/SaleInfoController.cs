...
namespace ProjectWeb.Areas.SaleManage.Controllers
{
    ...
    {
        private SaleInfoApp app = new SaleInfoApp();
        #region 页面显示
       
        [HttpGet]
        [HandlerAuthorize]
        public ActionResult SaleInfoShow()
        {
            return View();
        }
        ...
        [HttpGet]
        [HandlerAuthorize]
        public ActionResult SaleInfoApproval()
        {
            return View();
        }
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson(Pagination pagination, daoben_sale_salesinfo queryInfo,
           QueryTime queryTime)
        {   
            var data = new
            {
        ...
        public ActionResult Import(string importListStr, daoben_sale_salesinfo_approve importInfo)
        {
            List<daoben_sale_salesinfo> importList = importListStr.ToList<daoben_sale_salesinfo>();
            int delCount = 0;
        ...
        [HandlerAjaxOnly]
        [ValidateAntiForgeryToken]
        public ActionResult Approve(daoben_sale_salesinfo_approve approveInfo)
        {
