...
namespace ProjectWeb.Areas.SaleManage.Controllers
{
    ...
    {
        private RefundApp app = new RefundApp();
        #region 页面显示
        [HttpGet]
        [HandlerAuthorize]
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson(Pagination pagination, daoben_sale_refund queryInfo,
           QueryTime queryTime)
        {     
            var data = new
            {
        ...
        public ActionResult Import(string importListStr, daoben_sale_refund_approve importInfo)
        {
            List<daoben_sale_refund> importList = importListStr.ToList<daoben_sale_refund>();
            int delCount = 0;
        ...
        [HandlerAjaxOnly]
        [ValidateAntiForgeryToken]
        public ActionResult Approve(daoben_sale_refund_approve approveInfo)
        {
